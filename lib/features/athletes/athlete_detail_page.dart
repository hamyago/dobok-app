...
class _AthleteDetailPageState extends ConsumerState<AthleteDetailPage> {
  ...
  Widget _statutBadge(String? statut, {bool invert = false}) {
    final ok = statut == 'valide' || statut == 'signee' || statut == 'remis';
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
      decoration: BoxDecoration(
        color: ok ? AppTheme.success.withValues(alpha: 0.1) : AppTheme.error.withValues(alpha: 0.1),
